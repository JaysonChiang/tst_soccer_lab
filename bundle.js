...
/***/ function(module, exports, __webpack_require__) {
	...
	var _gameset = __webpack_require__(184);

	var _gameset2 = _interopRequireDefault(_gameset);

	var _getInverseZone2 = __webpack_require__(4);

	var _getInverseZone3 = _interopRequireDefault(_getInverseZone2);

	var _plotHero2 = __webpack_require__(5);

	var _plotHero3 = _interopRequireDefault(_plotHero2);

	var _HeroDataTable = __webpack_require__(193);

	var _HeroDataTable2 = _interopRequireDefault(_HeroDataTable);
	...
	var _q = queryString.parse(location.search);
	...
	var nextRound = function nextRound() {
	    ...
	    var DEFZonePlayers = DEFteam.playerList.filter(function (_p) {
	        return activePlayer.zone === +(0, _getInverseZone3.default)(_p.zone);
	    });
	...
	var chooseActionExe = function chooseActionExe(action) {
	...
	var shootGameBegin = function shootGameBegin(action) {
	...
	var exeCounter = function exeCounter() {
	    store.dispatch({
	...
	var shootGameExe = function shootGameExe(action) {
	...
	//============================
	var userActionOne = function userActionOne() {
	...
	var userActionTwo = function userActionTwo() {
	    //chooseActionPanel = hide;
	    clearTimeout(__ClearWaitChoose);
	    store.dispatch({
	        type: "changeUserAction",
	...
	var userActionThr = function userActionThr() {
	    //chooseActionPanel = hide;
	    clearTimeout(__ClearWaitChoose);
	    store.dispatch({
	        type: "changeUserAction",
	...
	//============================
	var userShootLT = function userShootLT() {
	    //chooseShootPanel = hide;
	...
	var userShootMT = function userShootMT() {
	    //chooseShootPanel = hide;
	    clearTimeout(__ClearWaitShoot);
	    store.dispatch({
	        type: "changeUserShoot",
	...
	var userShootRT = function userShootRT() {
	    //chooseShootPanel = hide;
	    clearTimeout(__ClearWaitShoot);
	    store.dispatch({
	        type: "changeUserShoot",
	...
	var userShootLB = function userShootLB() {
	    //chooseShootPanel = hide;
	    clearTimeout(__ClearWaitShoot);
	    store.dispatch({
	        type: "changeUserShoot",
	...
	var userShootMB = function userShootMB() {
	    //chooseShootPanel = hide;
	    clearTimeout(__ClearWaitShoot);
	    store.dispatch({
	        type: "changeUserShoot",
	...
	var userShootRB = function userShootRB() {
	    //chooseShootPanel = hide;
	    clearTimeout(__ClearWaitShoot);
	    store.dispatch({
	        type: "changeUserShoot",
	...
	var store = redux.createStore(_gameset2.default);
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { style: style.field },
	                    _react2.default.createElement(_Plot2.default, { act: store.getState().act, teams: store.getState().teams })
	                ),
	                _react2.default.createElement(
	                    'div',
	                    { style: style.modal },
	                    _react2.default.createElement(
	                        'div',
	                        { style: Object.assign({}, style.dialog, dialog.all) },
	                        _react2.default.createElement(
	                            'div',
	                            { style: dialog.gamestart },
	                            _react2.default.createElement(
	                                'button',
	                                { style: style.longbox, onClick: GameStart },
	                                'Start'
	                            )
	                        ),
	                        _react2.default.createElement(
	                            'div',
	                            { style: dialog.gameover },
	                            _react2.default.createElement(
	                                'button',
	                                { style: style.longbox },
	                                'GameOver ',
	                                ...
	                                'TST ',
	                                store.getState().score.my,
	                                ' : ',
	                                store.getState().score.your,
	                                ' PC'
	                            )
	                        ),
	                        _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            'div',
	                            { style: chooseActionPanel },
	                            _react2.default.createElement(
	                                'button',
	                                { style: style.box, onClick: userActionOne },
	                                ' SH '
	                            ),
	                            _react2.default.createElement(
	                                'button',
	                                { style: style.box, onClick: userActionTwo },
	                                ' DR '
	                            ),
	                            _react2.default.createElement(
	                                'button',
	                                { style: style.box, onClick: userActionThr },
	                                ' PS '
	                            ),
	                            _react2.default.createElement(
	                                'div',
	                                null,
	                                store.getState().timeCounter
	                            )
	                        ),
	                        _react2.default.createElement(
	                            'div',
	                            { style: chooseShootPanel },
	                            _react2.default.createElement(
	                                'div',
	                                null,
	                                _react2.default.createElement(
	                                    'button',
	                                    { style: style.box, onClick: userShootLT },
	                                    ' LT '
	                                ),
	                                _react2.default.createElement(
	                                    'button',
	                                    { style: style.box, onClick: userShootMT },
	                                    ' MT '
	                                ),
	                                _react2.default.createElement(
	                                    'button',
	                                    { style: style.box, onClick: userShootRT },
	                                    ' RT '
	                                )
	                            ),
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(
	                                    'button',
	                                    { style: style.box, onClick: userShootLB },
	                                    ' LB '
	                                ),
	                                _react2.default.createElement(
	                                    'button',
	                                    { style: style.box, onClick: userShootMB },
	                                    ' MB '
	                                ),
	                                _react2.default.createElement(
	                                    'button',
	                                    { style: style.box, onClick: userShootRB },
	                                    ' RB '
	                                )
	                            ),
	                            _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'span',
	                        null,
	                        'Set time : /?game=45000&term=500'
	                    )
	                ),
	                _react2.default.createElement(
	                    'div',
	                    null,
	                    _react2.default.createElement(_HeroDataTable2.default, { players: _data.myplayers }),
	                    _react2.default.createElement(_HeroDataTable2.default, { players: _data.yourplayers })
	                )
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Team = function Team(players, user, sideOFF) {
	    ...
	    var getOnePlayer = function getOnePlayer(players) {
	    ...
	    return {
	        ...
	        sideOFF: sideOFF,
	        goal: false,
	        getZonePlayersAll: function getZonePlayersAll(_zone) {
	            return this.playerList.filter(function (player) {
	                return player.zone === _zone;
	            });
	        },
	        getPlayersByPosition: function getPlayersByPosition(_position) {
	            return this.playerList.filter(function (player) {
	                return player.position === _position;
	            });
	        },
	        movePosition: function movePosition(_players) {
	            _players.forEach(function (player) {
	                player.zone = player.zone + 1;
	                player.DEFzone = +_getInverseZone(player.zone);
	            });
	        },
	        getOnePlayerInZone: function getOnePlayerInZone(zone) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _actionChance = __webpack_require__(6);

	var __p = _plotHero3.default;

	var Player = function Player(player, user) {
	    ...
	    var _iniZone = function _iniZone() {
	    ...
	    return {
	        ...
	        exeAction: function exeAction(action) {
	...
	var getSkillPoint = function getSkillPoint(action) {
	    return action.player.skill[action.type];
	};
	var throwDicePoint = function throwDicePoint() {
	    return Math.round(Math.random() * 5) + 1;
	};
	var getFieldPoint = function getFieldPoint(action) {
	...
	var GoalGamePoint = function GoalGamePoint(action) {
	...
	var WhereIsTheBall = function WhereIsTheBall(DEFindex, OFFindex) {
	    var point = 0;
	    var pointMap = {
	...
	var shoot = function shoot(action) {
	...
	var shootGK = function shootGK(action) {
	...
	var dribble = function dribble(action) {
	...
	var playGamePC = function playGamePC(action) {
	...
	var PKwithDEF = function PKwithDEF(action) {
	    ...
	    if (action.shootGK) {
	        DEF_player = action.DEFteam.getOnePlayerInZone(0); // Shoot GK
	            ...
	            DEF_player = action.DEFteam.getOnePlayerInZone(+(0, _getInverseZone3.default)(_player.zone));
	        }
...
/***/ function(module, exports) {
	...
	var _getInverseZone = function _getInverseZone(zone) {
	    switch (zone + "") {
	        case "1":
	            return "6";
	            break;
...
/***/ function(module, exports) {
	...
	var _plotHero = function _plotHero(player) {

	     return "[" + player.position + "]" + player.name;
	};

	module.exports = _plotHero;
...
/***/ function(module, exports) {
	...
	var _actionChance = function _actionChance(_position, _zone) {
	    var _zone = _zone + "";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PlotHero = __webpack_require__(165);

	var _PlotHero2 = _interopRequireDefault(_PlotHero);

	var _PlotFootball = __webpack_require__(166);

	var _PlotFootball2 = _interopRequireDefault(_PlotFootball);
	...
	var _inv = _getInverseZone3.default;
	...
	var getBallCoordinate = function getBallCoordinate(myTeam, yourTeam, getBallPlayer) {
	    if (myTeam.goal === true) {
	        pre = {}, end = {};
	...
	var doPlot = function doPlot(teams, act) {
	    ...
	    if (typeof pre.top === "undefined") {
	        ...
	        end.Springtop = (0, _reactMotion.spring)(end.top);
	        end.Springleft = (0, _reactMotion.spring)(end.left);
	    }
	    ...
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            ...
	            Allplayers.map(function (player) {
	                ...
	                return _react2.default.createElement(_PlotHero2.default, { coordinate: { zone: _zone, align: player.alignment },
	                    key: "_" + player.name,
	                    player: player,
	            ...
	            _react2.default.createElement(
	                _reactMotion.Motion,
	                { defaultStyle: { top: pre.top, left: pre.left }, style: { top: end.Springtop, left: end.Springleft } },
	                function (value) {
	                    return _react2.default.createElement(
	                        'div',
	                        null,
	                        _react2.default.createElement(_PlotFootball2.default, { act: act, key: 'ball', top: value.top, left: value.left })
	                    );
	                }
	            )
	        )
	...
	var Plot = (function (_Component) {
	    ...
	    function Plot() {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Plot).apply(this, arguments));
	    }
	...
	var Hero = (function (_Component) {
	  ...
	  _createClass(Hero, [{
	    ...
	    value: function render() {
	      ...
	      var playerStyle = Object.assign({}, style.player, { top: y, left: x, zIndex: z, boxShadow: "2px 2px 1px grey" }, { backgroundColor: player.isPlayer() ? 'rgba(255,204,51,0.8)' : 'rgba(255, 102, 153, 0.8)' });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Football = (function (_Component) {
	  _inherits(Football, _Component);

	  function Football() {
	    _classCallCheck(this, Football);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Football).apply(this, arguments));
	  }
	  ...
	  _createClass(Football, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        "div",
	        { style: Object.assign({}, position, style.pabs, { top: this.props.top, left: this.props.left }) },
	        _react2.default.createElement(
	          "span",
	          { style: style.act },
	          this.props.act
	        ),
	        _react2.default.createElement("img", { style: style.football, src: "../img/football.png" })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _components2 = __webpack_require__(168);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _noVelocity = __webpack_require__(169);

	var _noVelocity2 = _interopRequireDefault(_noVelocity);

	var _hasReachedStyle = __webpack_require__(170);
	...
	var _animationLoop = __webpack_require__(172);

	var _animationLoop2 = _interopRequireDefault(_animationLoop);

	var _zero = __webpack_require__(175);

	var _zero2 = _interopRequireDefault(_zero);

	var _updateTree = __webpack_require__(176);

	var _deprecatedSprings2 = __webpack_require__(180);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _stepper = __webpack_require__(177);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var teams = __webpack_require__(185);
	var score = __webpack_require__(190);
	var queryString = __webpack_require__(191);
	var _getInverseZone = __webpack_require__(4);

	var _q = queryString.parse(location.search);
	var GAMETIME = typeof _q.game === "undefined" ? 30 : _q.game / 1000;

	var gameset = function gameset(state, action) {
	    ...
	    if (typeof state === 'undefined') {
	        state = {
	            ...
	            count: 0,
	            teams: {
	                myTeam: new Team(data.myplayers, 'PL', !randomStart),
	                yourTeam: new Team(data.yourplayers, 'PC', !!randomStart)
	            },
	            align: false
	        };
	    ...
	    switch (action.type) {
	        ...
	        case "reset":
	            ...
	            var resetState = {
	                act: "",
	                teams: {
	                    myTeam: new Team(data.myplayers, 'PL', action.myTeamStart),
	                    yourTeam: new Team(data.yourplayers, 'PC', !action.myTeamStart)
	                },
	                align: false
	            };
	...
	var timePass = function timePass(state, action) {
	    return state - 1;
	};
	var resetTimeCounter = function resetTimeCounter(state, action) {
	    return 3;
	};
	var descTimeCounter = function descTimeCounter(state, action) {
	    return (state * 10 - 1) / 10;
	};
	var act = function act(state, action) {
	    return action.act;
	};
	var userAction = function userAction(state, action) {
	    return action.userAction;
	};
	var userShoot = function userShoot(state, action) {
	...
	var checkAlign = function checkAlign(state, action) {
	...
	var _getIniActivePlayer = function _getIniActivePlayer(team) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _passChance2 = __webpack_require__(186);

	var _passChance3 = _interopRequireDefault(_passChance2);
	...
	var team = __webpack_require__(187);

	var __p = _plotHero3.default;

	var teams = function teams(state, action) {
	...
	var _passPosition = function _passPosition(_position, _zone) {
	    var weights = (0, _passChance3.default)(_position, _zone);
	...
	var _pass = function _pass(team, ballKeeper) {
	    var newActivePlayer;
	...
	var _getActivePlayer = function _getActivePlayer(myTeam, yourTeam, ballKeeper) {
	...
	var _getOnePlayer = function _getOnePlayer(players) {
	    var randomIndex = Math.round(Math.random() * (players.length - 1));
	    return players[randomIndex];
	};

	var _catchBallPlayer = function _catchBallPlayer(state, action) {

	    var ActiveZone = action.ballKeeper.zone;
	    var AllplayersInZone = [];

	    var myPlayerInZone = state.myTeam.playerList.filter(function (_p) {
	        return state.myTeam.sideOFF ? _p.zone === ActiveZone : +(0, _getInverseZone3.default)(_p.zone) === ActiveZone;
	    });
	    var yourPlayerInZone = state.yourTeam.playerList.filter(function (_p) {
	        return state.yourTeam.sideOFF ? _p.zone === ActiveZone : +(0, _getInverseZone3.default)(_p.zone) === ActiveZone;
	    });
...
/***/ function(module, exports) {
	...
	var _passChance = function _passChance(_position, _zone) {
	    var _zone = _zone + "";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var players = __webpack_require__(188);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var player = __webpack_require__(189);

	var players = function players(state, action) {
...
/***/ function(module, exports) {
	...
	var player = function player(state, action) {
	    switch (action.type) {
	...
	var _movePlayerZone = function _movePlayerZone(state, action) {
	    if (action.sideOFF) {
	...
	var _moveOFFplayerZone = function _moveOFFplayerZone(_zone, action) {
	...
	var _moveDEFplayerZone = function _moveDEFplayerZone(_zone, action) {
...
/***/ function(module, exports) {
	...
	var score = function score(state, action) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HeroDataTable = (function (_Component) {
	  _inherits(HeroDataTable, _Component);

	  function HeroDataTable() {
	    _classCallCheck(this, HeroDataTable);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(HeroDataTable).apply(this, arguments));
	  }

	  _createClass(HeroDataTable, [{
	    key: "render",
	    value: function render() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsCombineReducers = __webpack_require__(198);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mapValues = __webpack_require__(199);
