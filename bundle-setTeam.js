...
/***/ function(module, exports, __webpack_require__) {
	...
	var _setTeamPlot = __webpack_require__(1);

	var _setTeamPlot2 = _interopRequireDefault(_setTeamPlot);
	...
	var addHero = function addHero(state, action) {
	    switch (action.type) {
	        case "addHero":
	            return [].concat(_toConsumableArray(state), [action.hero]);
	        default:
	            return state;
	    }
	};

	var removeHero = function removeHero(state, action) {
	    switch (action.type) {
	        case "removeHero":
	            return [].concat(_toConsumableArray(state.slice(0, action.idx)), _toConsumableArray(state.slice(action.idx + 1)));
	        default:
	            return state;
	    }
	};
	var setHero = function setHero(state, action) {
	    switch (action.type) {
	        case "name":
	            return Object.assign({}, state, {
	                name: action.value
	...
	var setHeroSkill = function setHeroSkill(state, action) {
	    switch (action.type) {
	        case "skillSH":
	            return Object.assign({}, state, {
	                SH: +action.value
	...
	var SetTeam = (function (_Component) {
	    _inherits(SetTeam, _Component);

	    function SetTeam() {
	        _classCallCheck(this, SetTeam);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(SetTeam).apply(this, arguments));
	    }

	    _createClass(SetTeam, [{
	        key: 'handleClick',
	        ...
	        key: 'handle',
	        value: function handle(e, attr) {
	            store.dispatch({ type: attr, value: e.target.value });
	        }
	    }, {
	        key: 'setCookie',
	        value: function setCookie(players) {
	            _jsCookie2.default.set('tst', players, { expires: 365 });
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { style: style.field },
	                    _react2.default.createElement(_setTeamPlot2.default, { act: "", team: this.props.players })
	                ),
	                _react2.default.createElement('br', { style: { clear: "both" } }),
	                _react2.default.createElement(
	                    'div',
	                    { style: { float: "left", width: "auto" } },
	                    _react2.default.createElement(DataTable, { players: store.getState().players })
	                ),
	                _react2.default.createElement(
	                    'div',
	                    { style: { float: "left" } },
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(
	                                    'td',
	                                    null,
	                                    _react2.default.createElement('input', { type: 'radio', name: 'position', onChange: function onChange(e) {
	                                            _this2.handle(e, "position");
	                                        }, value: 'FW' }),
	                                    'FW',
	                                    _react2.default.createElement('input', { type: 'radio', name: 'position', onChange: function onChange(e) {
	                                            _this2.handle(e, "position");
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(
	                                    'td',
	                                    null,
	                                    _react2.default.createElement('input', { type: 'radio', name: 'alignment', onChange: function onChange(e) {
	                                            _this2.handle(e, "alignment");
	                                        }, value: '1' }),
	                                    'L',
	                                    _react2.default.createElement('input', { type: 'radio', name: 'alignment', onChange: function onChange(e) {
	                                            _this2.handle(e, "alignment");
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(
	                                    'td',
	                                    null,
	                                    _react2.default.createElement('input', { type: 'number', name: 'skillSH', onChange: function onChange(e) {
	                                            _this2.handle(e, "skillSH");
	                                        }, value: setHero.skill.SH })
	                                )
	                            ),
	                            _react2.default.createElement(
	                                'tr',
	                                ...
	                                _react2.default.createElement(
	                                    'td',
	                                    null,
	                                    _react2.default.createElement('input', { type: 'number', name: 'skillDR', onChange: function onChange(e) {
	                                            _this2.handle(e, "skillDR");
	                                        }, value: setHero.skill.DR })
	                                )
	                            ),
	                            _react2.default.createElement(
	                                'tr',
	                                ...
	                                _react2.default.createElement(
	                                    'td',
	                                    null,
	                                    _react2.default.createElement('input', { type: 'number', name: 'skillPS', onChange: function onChange(e) {
	                                            _this2.handle(e, "skillPS");
	                                        }, value: setHero.skill.PS })
	                                )
	                            ),
	                            _react2.default.createElement(
	                                'tr',
	                                ...
	                                _react2.default.createElement(
	                                    'td',
	                                    null,
	                                    _react2.default.createElement('input', { type: 'number', name: 'skillDF', onChange: function onChange(e) {
	                                            _this2.handle(e, "skillDF");
	                                        }, value: setHero.skill.DF })
	                                )
	                            )
	                        )
	                    )
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'button',
	                        { onClick: function onClick() {
	                                _this2.setCookie(_this2.props.players);
	                            } },
	                        'set Cookie'
	                    )
	                )
	...
	var DataTable = (function (_Component2) {
	...
	var render = function render() {
	    ...
	    _reactDom2.default.render(_react2.default.createElement(SetTeam, { players: myState.players, setHero: myState.setHero }), document.getElementById('setTeam'));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _setTeamHero = __webpack_require__(160);

	var _setTeamHero2 = _interopRequireDefault(_setTeamHero);
	...
	var _iniZone = function _iniZone(position) {
	    switch (position) {
	        case "FW":
	            return 3;
	...
	var doPlot = function doPlot(list) {
	    ...
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            ...
	            PlayerList.map(function (player, idx) {
	                return _react2.default.createElement(_setTeamHero2.default, { coordinate: { zone: player.zone, align: player.alignment },
	...
	var Hero = (function (_Component) {
	  ...
	  _createClass(Hero, [{
	    ...
	    value: function render() {
	      ...
	      var playerStyle = Object.assign({}, style.player, { top: y, left: x, zIndex: z, boxShadow: "2px 2px 1px grey" }, { backgroundColor: 'rgba(255,204,51,0.8)' });
